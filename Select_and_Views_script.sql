...
--  Осуществим несколько представлений 

--  Количество друзей у всех пользователей 

CREATE OR REPLACE VIEW count_of_friend AS
...
CREATE OR REPLACE VIEW friend_movie_ratings AS
SELECT
	sm.*,
...
CREATE OR REPLACE VIEW sociable_friends AS
SELECT 
	from_user_id,
...
WHERE to_user_id = 1 -- может быть любым, в зависимости от задачи
