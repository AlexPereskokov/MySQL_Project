...
-- Добавим внешние ключи таблице фильмов 
...
-- Добавим индекс фильмам для поиска 
...
SELECT * FROM actors_and_directors;
...
-- Добавим ключи таблице комментарии для новостей
